<div class="nav-item dropdown">
    <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
        <span class="avatar avatar-sm rounded-circle">
            <img class="avatar avatar-sm rounded-circle bg-transparent" src="{{ backpack_auth()->user()->avatar ?? backpack_avatar_url(backpack_auth()->user()) }}"
    ...
    <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
        ...
        @endif
        <a href="{{ url('logout') }}" class="dropdown-item"><i class="la la-lock me-2"></i>{{ trans('backpack::base.logout') }}</a>
    </div>
</div>
