...
class AuthenticateSession extends LaravelAuthenticateSession
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        if ($request->session()->get('password_hash_'.backpack_guard_name()) !== $this->user->getAuthIdentifier()) {
            $this->logout($request);
        }
    ...
    protected function storePasswordHashInSession($request)
    {
        ...
        $request->session()->put([
            'password_hash_'.backpack_guard_name() => $this->user->getAuthIdentifier(),
        ]);
    }
    ...
    protected function logout($request)
    {
        ...
        throw new AuthenticationException('Unauthenticated.', [backpack_guard_name()], url('login'));
    }
